...
function tabs() {
    ...
    const preguntas = [
        "He tenido dificultades al comprender cuales son mis derechos fundamentales en salud, por:",
        "He tenido dificultades al acceso a la salud, por:",
        "He tenido dificultades en el trámite de un derecho de petición en salud, por:",
        "Ha tenido dificultades en el trámite administrativo en salud (ejemplo de trámites, acceso a dispositivos, consulta especializada, etc), por:",
        "He tenido dificultades en el mecanismo de protección de mis derechos fundamentales en salud por:",
        "He tenido dificultades en la protección a mi dignidad humana por las entidades prestadoras de Salud en el:"
    ];
