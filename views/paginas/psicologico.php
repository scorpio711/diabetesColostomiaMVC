<main class="container mx-auto p-4 md:py-12 mt-10">
        ...
        <header class="mb-4 flex items-center justify-between py-4 md:py-8">
            <section
                ...
                <div class="relative flex flex-col items-center p-4 sm:max-w-xl">
                    <p class="mb-4 text-center text-lg text-indigo-200 sm:text-xl md:mb-8">Estamos orgullosos de
                        presentarte
                    </p>
    ...
    <section class="bg-white dark:bg-gray-900">
        <div class="gap-16 items-center py-8 px-4 mx-auto max-w-screen-xl lg:grid lg:grid-cols-2 lg:py-16 lg:px-6">
            <div class="font-light text-gray-500 sm:text-lg dark:text-gray-400">
                <h2 class="mb-4 text-4xl tracking-tight font-extrabold text-gray-900 dark:text-white">Estamos para
                    ayudarte
                </h2>
                <p class="mb-4">We are strategists, designers and developers. Innovators and problem solvers. Small
                    enough
                    to be
                    simple and quick, but big enough to deliver the scope you want at the pace you need. Small enough to
                    be
                    simple
    ...
    <div class="bg-white py-6 sm:py-8 lg:py-12 dark:bg-gray-900">
        <div class="mx-auto max-w-screen-xl px-4 md:px-8">
            ...
            <div class="mb-10 md:mb-16">
                <h2 class="mb-4 text-center text-2xl font-bold text-gray-800 md:mb-6 lg:text-3xl dark:text-white">Conoce
                    Nuestro Equipo</h2>
    ...
    <div class="bg-white py-6 sm:py-8 lg:py-12 dark:bg-gray-900">
        <div class="mx-auto max-w-screen-xl px-4 md:px-8">
            <h2 class="mb-8 text-center text-2xl font-bold text-gray-800 md:mb-12 lg:text-3xl dark:text-white">Lo que
            ...
            <div class="grid gap-y-10 sm:grid-cols-2 sm:gap-y-12 lg:grid-cols-3 lg:divide-x">
                ...
                <div class="flex flex-col items-center gap-4 sm:px-4 md:gap-6 lg:px-8">
                    <div class="text-center text-gray-600 dark:text-gray-200">“This is a section of some simple filler
                        text, also known as
                    ...
                    <div class="flex flex-col items-center gap-2 sm:flex-row md:gap-3">
                        ...
                        <div>
                            <div class="text-center text-sm font-bold text-indigo-500 sm:text-left md:text-base">John
                                McCulling</div>
                ...
                <div class="flex flex-col items-center gap-4 sm:px-4 md:gap-6 lg:px-8">
                    ...
                    <div class="flex flex-col items-center gap-2 sm:flex-row md:gap-3">
                        ...
                        <div>
                            <div class="text-center text-sm font-bold text-indigo-500 sm:text-left md:text-base">Kate
                                Berg
                            </div>
                ...
                <div class="flex flex-col items-center gap-4 sm:px-4 md:gap-6 lg:px-8">
                    ...
                    <div class="flex flex-col items-center gap-2 sm:flex-row md:gap-3">
                        ...
                        <div>
                            <div class="text-center text-sm font-bold text-indigo-500 sm:text-left md:text-base">Greg
                                Jackson</div>
