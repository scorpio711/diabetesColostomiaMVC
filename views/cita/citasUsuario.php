            ...
            <div class="overflow-x-auto">
                <table class="w-full text-sm text-left text-gray-500 dark:text-gray-400">
                    <thead class="text-xs text-gray-700 uppercase bg-gray-50 dark:bg-gray-700 dark:text-gray-400">
                        <tr>
                            <th scope="col" class="px-4 py-4">Profesional</th>
                            <th scope="col" class="px-4 py-4">Email</th>
                            <th scope="col" class="px-4 py-4">Fecha de inicio</th>
                            <th scope="col" class="px-4 py-4">Fecha de fin</th>
...
<script src="/public/build/js/misCitas.js"></script>