...
<div class="bg-white dark:bg-gray-900 py-20 mx-auto max-w-screen-xl px-4 md:px-8">
    <div class="py-8">
        <h1
            ...
            Bienvenido a <mark class="px-2 text-white bg-blue-600 rounded dark:bg-blue-500">Citas</mark></h1>
        <p class="text-lg font-normal text-gray-500 lg:text-xl dark:text-gray-400">
            En este rincón especial, te ofrecemos la oportunidad de conocer a personas que comparten tus experiencias y
            comprenden tus vivencias. Nuestra plataforma está diseñada pensando en la empatía y el respeto,
            proporcionando un espacio donde puedes construir relaciones significativas con personas que comparten tu
            camino de vida.</p>
    </div>
