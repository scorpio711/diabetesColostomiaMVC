    ...
    <section class="mt-24 p-3 sm:p-5 antialiased">
        ...
        <?php elseif (intval($resultado) === 2): ?>
            <div id="alert-2"
                ...
                <span class="sr-only">Info</span>
                <div class="ml-3 text-sm font-medium">
                    El profesional ha sido actualizado
                </div>
                <button type="button"
                    class="ml-auto -mx-1.5 -my-1.5 bg-green-50 text-green-500 rounded-lg focus:ring-2 focus:ring-green-400 p-1.5 hover:bg-green-200 inline-flex h-8 w-8 dark:bg-gray-800 dark:text-green-400 dark:hover:bg-gray-700"
        ...
        <?php if (!empty($erroresActualizacion)): ?>
            <div id="alert-5" class="flex p-4 mb-4 text-red-800 rounded-lg bg-red-50 dark:bg-gray-800 dark:text-red-400"
                role="alert">
                <svg aria-hidden="true" class="flex-shrink-0 w-5 h-5" fill="currentColor" viewBox="0 0 20 20"
                    xmlns="http://www.w3.org/2000/svg">
                    <path fill-rule="evenodd"
                    ...
                    <table class="w-full text-sm text-left text-gray-500 dark:text-gray-400">
                        <thead class="text-xs text-gray-700 uppercase bg-gray-50 dark:bg-gray-700 dark:text-gray-400">
                            <tr>
                                ...
                                <th scope="col" class="px-4 py-4">Apellido</th>
                                <th scope="col" class="px-4 py-3">Email</th>
                                <th scope="col" class="px-4 py-3">Telefono</th>
                                <th scope="col" class="px-4 py-3">Profesion</th>
                        ...
                        <tbody>
                            <?php foreach ($profesionales as $profesional): ?>
                                <tr class="border-b dark:border-gray-700">
                                    ...
                                    <th scope="row"
                                        class="px-4 py-3 font-medium text-gray-900 whitespace-nowrap dark:text-white">
                                        <?php echo $profesional->apellido; ?>
                                    </th>

                                    <td class="px-4 py-3 max-w-[12rem] truncate">
                                        <?php echo $profesional->email; ?>
                                    </td>

                                    <td class="px-4 py-3 max-w-[12rem] truncate">
                                        <?php echo $profesional->telefono; ?>
                                    </td>
                                    ...
                                    <!-- <td class="px-4 py-3 flex items-center justify-end">
                                        <button id="apple-imac-27-dropdown-button<?php echo $profesional->id; ?>"
                                            data-dropdown-toggle="apple-imac-27-dropdown<?php echo $profesional->id; ?>"
                                        ...
                                        <div id="apple-imac-27-dropdown<?php echo $profesional->id; ?>"
                                            class="hidden z-10 w-44 bg-white rounded divide-y divide-gray-100 shadow dark:bg-gray-700 dark:divide-gray-600">
                                            <ul class="py-1 text-sm" aria-labelledby="apple-imac-27-dropdown-button">
                                                <li>
                                                    <button type="button"
                                                        data-modal-target="updateProductModal<?php echo $profesional->id; ?>"
                                                        data-modal-toggle="updateProductModal<?php echo $profesional->id; ?>"
                                                ...
                                                <li>
                                                    <button type="button"
                                                        data-modal-target="deleteModal<?php echo $profesional->id; ?>"
                                                        data-modal-toggle="deleteModal<?php echo $profesional->id; ?>"
                ...
                <form method="POST" enctype="multipart/form-data">
                    <div class="grid gap-4 mb-4 sm:grid-cols-2">
                        <div>
                            ...
                            <input value="<?php echo s($profesionalC->email); ?>" type="email" name="email" id="email"
                        ...
                        <div>
                            ...
                            <input value="<?php echo s($profesionalC->nombre); ?>" type="text" name="nombre" id="nombre"
                                class="bg-gray-50 border border-gray-300 text-gray-900 text-sm rounded-lg focus:ring-primary-600 focus:border-primary-600 block w-full p-2.5 dark:bg-gray-700 dark:border-gray-600 dark:placeholder-gray-400 dark:text-white dark:focus:ring-primary-500 dark:focus:border-primary-500"
                        ...
                        <div>
                            ...
                            <input value="<?php echo s($profesionalC->apellido); ?>" type="text" name="apellido"
                                id="apellido"
                                class="bg-gray-50 border border-gray-300 text-gray-900 text-sm rounded-lg focus:ring-primary-600 focus:border-primary-600 block w-full p-2.5 dark:bg-gray-700 dark:border-gray-600 dark:placeholder-gray-400 dark:text-white dark:focus:ring-primary-500 dark:focus:border-primary-500"
                                placeholder="Escribre tu apellido" required="">
                        </div>
                        <div>
                            <label for="telefono"
                                class="block mb-2 text-sm font-medium text-gray-900 dark:text-white">telefono
                            </label>
                            <input value="<?php echo s($profesionalC->telefono); ?>" type="number" name="telefono"
                                id="telefono"
                                class="bg-gray-50 border border-gray-300 text-gray-900 text-sm rounded-lg focus:ring-primary-600 focus:border-primary-600 block w-full p-2.5 dark:bg-gray-700 dark:border-gray-600 dark:placeholder-gray-400 dark:text-white dark:focus:ring-primary-500 dark:focus:border-primary-500"
                                placeholder="Escribre tu número telefonico" required="">
                        </div>
                        <div>
                        ...
                        <div class="w-full">
                            ...
                            <select name="profesion"
                                class="bg-gray-50 border border-gray-300 text-gray-900 text-sm rounded-lg focus:ring-blue-500 focus:border-blue-500 block w-full p-2.5 dark:bg-gray-700 dark:border-gray-600 dark:placeholder-gray-400 dark:text-white dark:focus:ring-blue-500 dark:focus:border-blue-500">
                                <option selected value="">Escoge la profesion</option>
                                <option value="abogado" <?php echo $profesionalC->profesion === "abogado" ? "selected" : '' ?>>
                                    Abogado</option>
                                <option value="psicologo" <?php echo $profesionalC->profesion === "psicologo" ? "selected" : '' ?>>
                                    Psicologo</option>
                                <option value="enfermero" <?php echo $profesionalC->profesion === "enfermero" ? "selected" : '' ?>>
                                    Enfermero</option>
                            </select>
                        </div>
                        <div>
                            ...
                            <input type="password" name="contraseña" id="contraseña"
                                class="bg-gray-50 border border-gray-300 text-gray-900 text-sm rounded-lg focus:ring-primary-600 focus:border-primary-600 block w-full p-2.5 dark:bg-gray-700 dark:border-gray-600 dark:placeholder-gray-400 dark:text-white dark:focus:ring-primary-500 dark:focus:border-primary-500"
                                placeholder="Escribre tu contraseña" required="">
                        </div>
                    </div>
                                ...
                                <div class="w-full">
                                    ...
                                    <select name="usuario[rol]"
                                        ...
                                        <option value="abogado" <?php echo $usuario->rol === "abogado" ? "selected" : '' ?>>
                                            Abogado</option>
                                        <option value="psicologo" <?php echo $usuario->rol === "psicologo" ? "selected" : '' ?>>Psicologo</option>
