                    ...
                    <table class="w-full text-sm text-left text-gray-500 dark:text-gray-400">
                        <thead class="text-xs text-gray-700 uppercase bg-gray-50 dark:bg-gray-700 dark:text-gray-400">
                            <tr>
                                ...
                                <th scope="col" class="px-4 py-3">Tristeza_depresión</th>
                                <th scope="col" class="px-4 py-3">Ansiedad</th>
                                <th scope="col" class="px-4 py-3">Ira_hostilidad</th>
                                <th scope="col" class="px-4 py-3">Alegria</th>
                        ...
                        <tbody>
                            <?php foreach ($encuestas as $encuesta): ?>
                                ...
                                <tr class="border-b dark:border-gray-700">
                                    ...
                                    <td class="px-4 py-3 max-w-[12rem] truncate">
                                        <?php echo $encuesta["tristeza_depresion"]; ?>
                                    </td>
                                    <td class="px-4 py-3 max-w-[12rem] truncate">
                                        <?php echo $encuesta["ansiedad"]; ?>
                                    </td>
                                    <td class="px-4 py-3 max-w-[12rem] truncate">
                                        <?php echo $encuesta["ira_hostilidad"]; ?>
                                    </td>
                                    <td class="px-4 py-3 max-w-[12rem] truncate">
                                        <?php echo $encuesta["alegria"]; ?>
                                    </td>
                                    <td class="px-4 py-3 max-w-[12rem] truncate">
                                        <?php echo $encuesta["intento"]; ?>
                                    </td>
                                    <td class="px-4 py-3 max-w-[12rem] truncate">
                                        <?php echo $encuesta["encuesta_psicologia"] == 1 ? "No" : "Sí"; ?>
                                    </td>
                                    <!-- <td class="px-4 py-3">
