                    ...
                    <table class="w-full text-sm text-left text-gray-500 dark:text-gray-400">
                        <thead class="text-xs text-gray-700 uppercase bg-gray-50 dark:bg-gray-700 dark:text-gray-400">
                            <tr>
                                ...
                                <th scope="col" class="px-4 py-3">Fundamental</th>
                                <th scope="col" class="px-4 py-3">salud</th>
                                <th scope="col" class="px-4 py-3">petición</th>
                                <th scope="col" class="px-4 py-3">proceso</th>
                                <th scope="col" class="px-4 py-3">Tutela</th>
                                <th scope="col" class="px-4 py-3">Dignidad</th>
                        ...
                        <tbody>
                            <?php foreach ($encuestas as $encuesta): ?>
                                ...
                                <tr class="border-b dark:border-gray-700">
                                    ...
                                    <td class="px-4 py-3 max-w-[12rem] truncate">
                                        <?php echo $encuesta["fundamental"]; ?>
                                    </td>
                                    <td class="px-4 py-3 max-w-[12rem] truncate">
                                        <?php echo $encuesta["salud"]; ?>
                                    </td>
                                    <td class="px-4 py-3 max-w-[12rem] truncate">
                                        <?php echo $encuesta["peticion"]; ?>
                                    </td>
                                    <td class="px-4 py-3 max-w-[12rem] truncate">
                                        <?php echo $encuesta["proceso"]; ?>
                                    </td>
                                    <td class="px-4 py-3 max-w-[12rem] truncate">
                                        <?php echo $encuesta["tutela"]; ?>
                                    </td>
                                    <td class="px-4 py-3 max-w-[12rem] truncate">
                                        <?php echo $encuesta["dignidad"]; ?>
                                    </td>
                                    <td class="px-4 py-3 max-w-[12rem] truncate">
                                    ...
                                    <td class="px-4 py-3 max-w-[12rem] truncate">
                                        <?php echo $encuesta["encuesta_juridico"] == 1 ? "No" : "Sí"; ?>
                                    </td>
                                    <!-- <td class="px-4 py-3">
