<main class="contenedor">
    <section class="mt-12">
        <div class="py-8 px-4 mx-auto max-w-screen-xl lg:py-16">
            <h1 class="mb-4 text-3xl font-extrabold text-gray-900 dark:text-white md:text-5xl lg:text-6xl">Administrador
                <span
                    class="text-transparent bg-clip-text bg-gradient-to-r to-green-400 from-blue-800 dark:from-green-500 dark:to-lime-500">Profesionales</span>
            </h1>
            ...
            <div class="grid md:grid-cols-2 lg:grid-cols-3 gap-6">
                <div
                    ...
                    <h2 class="text-gray-900 dark:text-white text-3xl font-extrabold mb-2">Investigaciones
                    </h2>
                ...
                <div
                    ...
                    <h2 class="text-gray-900 dark:text-white text-3xl font-extrabold mb-2">Pacientes</h2>
                ...
                <div
                    ...
                    <h2 class="text-gray-900 dark:text-white text-3xl font-extrabold mb-2">Citas</h2>
                ...
                <!-- <div
                    ...
                    <h2 class="text-gray-900 dark:text-white text-3xl font-extrabold mb-2">Servicios</h2>
                ...
                <div
                    ...
                    <h2 class="text-gray-900 dark:text-white text-3xl font-extrabold mb-2">Encuesta Psicología</h2>
                ...
                <div
                    ...
                    <h2 class="text-gray-900 dark:text-white text-3xl font-extrabold mb-2">Encuesta Juridica</h2>
