<main class="contenedor ">
    ...
    <section class="mt-24 p-3 sm:p-5 antialiased">
        ...
        <?php elseif (intval($resultado) === 2): ?>
            <div id="alert-2"
                ...
                <span class="sr-only">Info</span>
                <div class="ml-3 text-sm font-medium">
                    El servicio ha sido actualizada
                </div>
                <button type="button"
                    class="ml-auto -mx-1.5 -my-1.5 bg-green-50 text-green-500 rounded-lg focus:ring-2 focus:ring-green-400 p-1.5 hover:bg-green-200 inline-flex h-8 w-8 dark:bg-gray-800 dark:text-green-400 dark:hover:bg-gray-700"
                    data-dismiss-target="#alert-2" aria-label="Close">
        ...
        <?php if (!empty($errores)): ?>
            <div id="alert-2" class="flex p-4 mb-4 text-red-800 rounded-lg bg-red-50 dark:bg-gray-800 dark:text-red-400"
                ...
                <span class="sr-only">Info</span>
                <div class="ml-3 text-sm font-medium">
                    Error al crear el Servicio revisa nuevamente
                </div>
                <button type="button"
        ...
        <?php if (!empty($erroresActualizacion)): ?>
            <div id="alert-4" class="flex p-4 mb-4 text-red-800 rounded-lg bg-red-50 dark:bg-gray-800 dark:text-red-400"
                ...
                <span class="sr-only">Info</span>
                <div class="ml-3 text-sm font-medium">
                    Error al actualizar el servicio revisa nuevamente
                </div>
                <button type="button"
                    class="ml-auto -mx-1.5 -my-1.5 bg-red-50 text-red-500 rounded-lg focus:ring-2 focus:ring-red-400 p-1.5 hover:bg-red-200 inline-flex h-8 w-8 dark:bg-gray-800 dark:text-red-400 dark:hover:bg-gray-700"
                    ...
                    <table class="w-full text-sm text-left text-gray-500 dark:text-gray-400">
                        <thead class="text-xs text-gray-700 uppercase bg-gray-50 dark:bg-gray-700 dark:text-gray-400">
                            <tr>
                                ...
                                <th scope="col" class="px-4 py-4">nombre_servicio</th>
                            ...
                            <?php foreach ($servicios as $servicio): ?>
                                <tr class="border-b dark:border-gray-700">
                                    ...
                                    <td class="px-4 py-3 flex items-center justify-end">
                                        <button id="apple-imac-27-dropdown-button<?php echo $servicio->id; ?>"
                                            data-dropdown-toggle="apple-imac-27-dropdown<?php echo $servicio->id; ?>"
                                        ...
                                        <div id="apple-imac-27-dropdown<?php echo $servicio->id; ?>"
                                            class="hidden z-10 w-44 bg-white rounded divide-y divide-gray-100 shadow dark:bg-gray-700 dark:divide-gray-600">
                                            <ul class="py-1 text-sm" aria-labelledby="apple-imac-27-dropdown-button">
                                                <li>
                                                    <button type="button"
                                                        data-modal-target="updateProductModal<?php echo $servicio->id; ?>"
                                                        data-modal-toggle="updateProductModal<?php echo $servicio->id; ?>"
                                                ...
                                                <li>
                                                    <button type="button"
                                                        data-modal-target="deleteModal<?php echo $servicio->id; ?>"
                                                        data-modal-toggle="deleteModal<?php echo $servicio->id; ?>"
        ...
        <div class="relative p-4 w-full max-w-2xl max-h-full">
            ...
            <div class="relative p-4 bg-white rounded-lg shadow dark:bg-gray-800 sm:p-5">
                ...
                <div
                    ...
                    <h3 class="text-lg font-semibold text-gray-900 dark:text-white">Añadir Servicio</h3>
                    <button type="button"
                    ...
                    <div class="grid gap-4 mb-4">
                        <div>
                            <label for="nombre_servicio"
                                ...
                                Servicio</label>
                            <input value="<?php echo s($servicioC->nombre_servicio); ?>" type="text"
                                name="nombre_servicio" id="nombre_servicio"
                                class="bg-gray-50 border border-gray-300 text-gray-900 text-sm rounded-lg focus:ring-primary-600 focus:border-primary-600 block w-full p-2.5 dark:bg-gray-700 dark:border-gray-600 dark:placeholder-gray-400 dark:text-white dark:focus:ring-primary-500 dark:focus:border-primary-500"
                                placeholder="Escribe el nombre de tu servicio" required="">
                        </div>

                        <div>
                            <div class="sm:col-span-2 mt-2"><label for="descripcion"
                                    class="block mb-2 text-sm font-medium text-gray-900 dark:text-white">Descripcion</label><textarea
                                    id="descripcion" name="descripcion" rows="4"
                                    class="block p-2.5 w-full text-sm text-gray-900 bg-gray-50 rounded-lg border border-gray-300 focus:ring-primary-500 focus:border-primary-500 dark:bg-gray-700 dark:border-gray-600 dark:placeholder-gray-400 dark:text-white dark:focus:ring-primary-500 dark:focus:border-primary-500"
                                    placeholder="Pon aqui la descripcion"><?php echo s($servicioC->descripcion); ?></textarea>
                            </div>
                        </div>
                    </div>
    ...
    <?php foreach ($servicios as $servicio): ?>
        <div id="updateProductModal<?php echo $servicio->id; ?>" tabindex="-1" aria-hidden="true"
            ...
            <div class="relative p-4 w-full max-w-2xl max-h-full">
                ...
                <div class="relative p-4 bg-white rounded-lg shadow dark:bg-gray-800 sm:p-5">
                    ...
                    <div
                        class="flex justify-between items-center pb-4 mb-4 rounded-t border-b sm:mb-5 dark:border-gray-600">
                        <h3 class="text-lg font-semibold text-gray-900 dark:text-white">Actualizar servicio</h3>
                        <button type="button"
                            class="text-gray-400 bg-transparent hover:bg-gray-200 hover:text-gray-900 rounded-lg text-sm p-1.5 ml-auto inline-flex items-center dark:hover:bg-gray-600 dark:hover:text-white"
                            data-modal-toggle="updateProductModal<?php echo $servicio->id; ?>">
                            <svg aria-hidden="true" class="w-5 h-5" fill="currentColor" viewbox="0 0 20 20"
                    ...
                    <form method="POST" enctype="multipart/form-data">
                        <div class="grid gap-4 mb-4">
                            <input type="number" name="id" class="hidden" value="<?php echo $servicio->id; ?>">
                            <div>
                                <label for="nombre_servicio"
                                    class="block mb-2 text-sm font-medium text-gray-900 dark:text-white">Nombre
                                    Servicio</label>
                                <input value="<?php echo s($servicio->nombre_servicio); ?>" type="text"
                                    name="nombre_servicio" id="nombre_servicio"
                                    class="bg-gray-50 border border-gray-300 text-gray-900 text-sm rounded-lg focus:ring-primary-600 focus:border-primary-600 block w-full p-2.5 dark:bg-gray-700 dark:border-gray-600 dark:placeholder-gray-400 dark:text-white dark:focus:ring-primary-500 dark:focus:border-primary-500"
                                    placeholder="Escribe el nombre de tu servicio" required="">
                            </div>
                            ...
                            <div>
                                <div class="sm:col-span-2 mt-2"><label for="descripcion"
                                        ...
                                        id="descripcion" name="descripcion" rows="4"
                                        class="block p-2.5 w-full text-sm text-gray-900 bg-gray-50 rounded-lg border border-gray-300 focus:ring-primary-500 focus:border-primary-500 dark:bg-gray-700 dark:border-gray-600 dark:placeholder-gray-400 dark:text-white dark:focus:ring-primary-500 dark:focus:border-primary-500"
                                        placeholder="Pon aqui la descripcion"><?php echo s($servicio->descripcion); ?></textarea>
                                </div>
                            </div>
                        </div>
    ...
    <!-- Delete modal -->
    <?php foreach ($servicios as $servicio): ?>
        <div id="deleteModal<?php echo $servicio->id; ?>" tabindex="-1" aria-hidden="true"
            class="hidden overflow-y-auto overflow-x-hidden fixed top-0 right-0 left-0 z-50 justify-center items-center w-full md:inset-0 h-[calc(100%-1rem)] max-h-full">
            <div class="relative p-4 w-full max-w-md max-h-full">
                ...
                <div class="relative p-4 text-center bg-white rounded-lg shadow dark:bg-gray-800 sm:p-5">
                    ...
                    <p class="mb-4 text-gray-500 dark:text-gray-300">¿Estas seguro de borrar esta servicio?</p>
                    <div class="flex justify-center align-center items-center space-x-4">
                        <button data-modal-toggle="deleteModal<?php echo $servicio->id; ?>" type="button"
                            class="py-2 px-3 text-sm font-medium text-gray-500 bg-white rounded-lg border border-gray-200 hover:bg-gray-100 focus:ring-4 focus:outline-none focus:ring-primary-300 hover:text-gray-900 focus:z-10 dark:bg-gray-700 dark:text-gray-300 dark:border-gray-500 dark:hover:text-white dark:hover:bg-gray-600 dark:focus:ring-gray-600">No,
                            cancelar</button>
                        <form method="POST" class="m-0""
                            enctype=" multipart/form-data">
                            <input type="number" name="id" class="hidden" value="<?php echo $servicio->id; ?>">
                            <input type="text" name="tipo" class="hidden" value="servicio">
