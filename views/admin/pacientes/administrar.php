<main class="contenedor">
                    ...
                    <table class="w-full text-sm text-left text-gray-500 dark:text-gray-400">
                        <thead class="text-xs text-gray-700 uppercase bg-gray-50 dark:bg-gray-700 dark:text-gray-400">
                            <tr>
                                ...
                                <th scope="col" class="px-4 py-4">Telefono</th>
                                <th scope="col" class="px-4 py-3">edad</th>
                                <th scope="col" class="px-4 py-3">sexo</th>
                                <th scope="col" class="px-4 py-3">escolaridad</th>
                                <th scope="col" class="px-4 py-3">estrato</th>
                                <th scope="col" class="px-4 py-3">lugar</th>
                                <th scope="col" class="px-4 py-3">ocupacion</th>
                                <th scope="col" class="px-4 py-3">apoyo</th>
                        ...
                        <tbody>
                            <?php foreach ($pacientes as $paciente): ?>
                                <tr class="border-b dark:border-gray-700">
                                    ...
                                    <td class="px-4 py-3">
                                        <?php echo $paciente->escolaridad; ?>
                                    </td>
                                    <td class="px-4 py-3 max-w-[12rem] truncate">
                                        <?php echo $paciente->estrato_socioeconomico; ?>
                                    </td>
                                    <td class="px-4 py-3 max-w-[12rem] truncate">
                                        <?php echo $paciente->lugar_de_residencia; ?>
                                    </td>
                                    <td class="px-4 py-3 max-w-[12rem] truncate">
                                        <?php echo $paciente->ocupacion; ?>
                                    </td>
                                    <td class="px-4 py-3 max-w-[12rem] truncate">
                                        <?php echo $paciente->apoyo; ?>
                                    </td>
                                    <td class="px-4 py-3 max-w-[12rem] truncate">
                                        <?php echo $paciente->afiliacion; ?>
                                    </td>
                                    <td class="px-4 py-3 max-w-[12rem] truncate">
                                        <?php echo $paciente->tiempo_enfermedad; ?>
                                    </td>
                                    <td class="px-4 py-3">
                                        <button data-popover-target="popover-default<?php echo $paciente->pacienteId; ?>"
                                            type="button"
                                        ...
                                        <div data-popover id="popover-default<?php echo $paciente->pacienteId; ?>" role="tooltip"
                                    ...
                                    <!-- <td class="px-4 py-3 flex items-center justify-end">
                                        ...
                                        <div id="apple-imac-27-dropdown<?php echo $paciente->id; ?>"
                                            class="hidden z-10 w-44 bg-white rounded divide-y divide-gray-100 shadow dark:bg-gray-700 dark:divide-gray-600">
                                            <ul class="py-1 text-sm" aria-labelledby="apple-imac-27-dropdown-button">
                                                <li>
                                                    <button type="button"
                                                        data-modal-target="updateProductModal<?php echo $paciente->id; ?>"
                                                        data-modal-toggle="updateProductModal<?php echo $paciente->id; ?>"
                                                ...
                                                <li>
                                                    <button type="button"
                                                        data-modal-target="deleteModal<?php echo $paciente->id; ?>"
                                                        data-modal-toggle="deleteModal<?php echo $paciente->id; ?>"
    ...
    <?php foreach ($pacientes as $paciente): ?>
        <div id="updateProductModal<?php echo $paciente->id; ?>" tabindex="-1" aria-hidden="true"
            ...
            <div class="relative p-4 w-full max-w-2xl max-h-full">
                ...
                <div class="relative p-4 bg-white rounded-lg shadow dark:bg-gray-800 sm:p-5">
                    ...
                    <div
                        class="flex justify-between items-center pb-4 mb-4 rounded-t border-b sm:mb-5 dark:border-gray-600">
                        <h3 class="text-lg font-semibold text-gray-900 dark:text-white">Actualizar paciente</h3>
                        <button type="button"
                            class="text-gray-400 bg-transparent hover:bg-gray-200 hover:text-gray-900 rounded-lg text-sm p-1.5 ml-auto inline-flex items-center dark:hover:bg-gray-600 dark:hover:text-white"
                            data-modal-toggle="updateProductModal<?php echo $paciente->id; ?>">
                            <svg aria-hidden="true" class="w-5 h-5" fill="currentColor" viewbox="0 0 20 20"
    ...
    <!-- Delete modal -->
    <?php foreach ($pacientes as $paciente): ?>
        <div id="deleteModal<?php echo $paciente->id; ?>" tabindex="-1" aria-hidden="true"
            class="hidden overflow-y-auto overflow-x-hidden fixed top-0 right-0 left-0 z-50 justify-center items-center w-full md:inset-0 h-[calc(100%-1rem)] max-h-full">
            <div class="relative p-4 w-full max-w-md max-h-full">
                ...
                <div class="relative p-4 text-center bg-white rounded-lg shadow dark:bg-gray-800 sm:p-5">
                    ...
                    <div class="flex justify-center align-center items-center space-x-4">
                        <button data-modal-toggle="deleteModal<?php echo $paciente->id; ?>" type="button"
                            class="py-2 px-3 text-sm font-medium text-gray-500 bg-white rounded-lg border border-gray-200 hover:bg-gray-100 focus:ring-4 focus:outline-none focus:ring-primary-300 hover:text-gray-900 focus:z-10 dark:bg-gray-700 dark:text-gray-300 dark:border-gray-500 dark:hover:text-white dark:hover:bg-gray-600 dark:focus:ring-gray-600">No,
                            cancelar</button>
                        <form method="POST" class="m-0""
                            enctype=" multipart/form-data">
                            <input type="number" name="id" class="hidden" value="<?php echo $paciente->id; ?>">
...
<script>
    document.getElementById('exportExcel').addEventListener('click', function () {
        // Selecciona la tabla (ajusta el selector según tu HTML)
