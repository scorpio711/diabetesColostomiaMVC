<main class="contenedor">
    ...
    <section class="mt-24 p-3 sm:p-5 antialiased">
        ...
        <?php if (!empty($errores)): ?>
            <div id="alert-2" class="flex p-4 mb-4 text-red-800 rounded-lg bg-red-50 dark:bg-gray-800 dark:text-red-400"
                ...
                <span class="sr-only">Info</span>
                <div class="ml-3 text-sm font-medium">
                    Error al crear el blog revisa nuevamente
                </div>
                <button type="button"
                    ...
                    <table class="w-full text-sm text-left text-gray-500 dark:text-gray-400">
                        <thead class="text-xs text-gray-700 uppercase bg-gray-50 dark:bg-gray-700 dark:text-gray-400">
                            <tr>
                                ...
                                <th scope="col" class="px-4 py-4">Fecha de creación</th>
                            ...
                            <?php foreach ($blogs as $blog): ?>
                                <tr class="border-b dark:border-gray-700">
                                    ...
                                    <th scope="row"
                                        ...
                                        <?php echo $blog->nombre; ?>
                                    </th>
                                    <th scope="row"
                                        class="px-4 py-3 font-medium text-gray-900 whitespace-nowrap dark:text-white">
                                        <?php echo $blog->fecha_creacion; ?>
                                    </th>


                                    <td class="px-4 py-3 flex items-center justify-end">
                                        <button id="apple-imac-27-dropdown-button<?php echo $blog->id; ?>"
                                            data-dropdown-toggle="apple-imac-27-dropdown<?php echo $blog->id; ?>"
                                        ...
                                        <div id="apple-imac-27-dropdown<?php echo $blog->id; ?>"
                                            class="hidden z-10 w-44 bg-white rounded divide-y divide-gray-100 shadow dark:bg-gray-700 dark:divide-gray-600">
                                            <ul class="py-1 text-sm" aria-labelledby="apple-imac-27-dropdown-button">
                                                <li>
                                                    <a href="/public/blog?id=<?php echo $blog->id; ?>">
                                                        <button type="button"
                                                            data-modal-target="updateProductModal<?php echo $blog->id; ?>"
                                                            data-modal-toggle="updateProductModal<?php echo $blog->id; ?>"
                                                ...
                                                <li>
                                                    <button type="button"
                                                        data-modal-target="deleteModal<?php echo $blog->id; ?>"
                                                        data-modal-toggle="deleteModal<?php echo $blog->id; ?>"
        ...
        <div class="relative p-4 w-full max-w-2xl max-h-full">
            ...
            <div class="relative p-4 bg-white rounded-lg shadow dark:bg-gray-800 sm:p-5">
                ...
                <div
                    ...
                    <h3 class="text-lg font-semibold text-gray-900 dark:text-white">Crea tu blog</h3>
                    <button type="button"
                ...
                <?php foreach ($errores as $error): ?>
                    <div class="flex p-4 mb-4 text-sm text-red-800 rounded-lg bg-red-50 dark:bg-gray-800 dark:text-red-400 max-w-xl"
                        role="alert">
    ...
    <?php foreach ($blogs as $blog): ?>
        <div id="updateProductModal<?php echo $blog->id; ?>" tabindex="-1" aria-hidden="true"
            ...
            <div class="relative p-4 w-full max-w-2xl max-h-full">
                ...
                <div class="relative p-4 bg-white rounded-lg shadow dark:bg-gray-800 sm:p-5">
                    ...
                    <div
                        class="flex justify-between items-center pb-4 mb-4 rounded-t border-b sm:mb-5 dark:border-gray-600">
                        <h3 class="text-lg font-semibold text-gray-900 dark:text-white">Actualizar blog</h3>
                        <button type="button"
                            class="text-gray-400 bg-transparent hover:bg-gray-200 hover:text-gray-900 rounded-lg text-sm p-1.5 ml-auto inline-flex items-center dark:hover:bg-gray-600 dark:hover:text-white"
                            data-modal-toggle="updateProductModal<?php echo $blog->id; ?>">
                            <svg aria-hidden="true" class="w-5 h-5" fill="currentColor" viewbox="0 0 20 20"
    ...
    <!-- Delete modal -->
    <?php foreach ($blogs as $blog): ?>
        <div id="deleteModal<?php echo $blog->id; ?>" tabindex="-1" aria-hidden="true"
            class="hidden overflow-y-auto overflow-x-hidden fixed top-0 right-0 left-0 z-50 justify-center items-center w-full md:inset-0 h-[calc(100%-1rem)] max-h-full">
